...
| `fm-launch-send-lib.sh`  | Shared launch-command delivery for a fresh worker pane: gate on shell readiness, then chunk the write below the pseudo-terminal input queue |
